import { DateObjectUnits, DatePickerOnChange, DatePickerType, MonthDaysObject, MonthStatus, Locale, MakeOptionalRequired } from './types';
...
export declare const getMonthDaysArray: (month: number, year: number, option?: Options) => MonthDaysObject<string>[];
