import { use as I, insert as c, createComponent as N, effect as k, className as m, style as P, delegateEvents as W, template as $ } from "solid-js/web";
...
import { smartDropDownPosition as M } from "../../../node_modules/.pnpm/@rnwonder_simple-datejs@1.0.8/node_modules/@rnwonder/simple-datejs/dist/utils.js";
import { cn as g } from "../../utils/class.js";
var E = $("<div data-type=dropdown>"), x = $("<div><div>");
const H = (e) => {
  const [h, z] = a(), [f, D] = a(), [L, O] = a(), [w, R] = a(), [r, d] = a(!1), [u, v] = a(!1), p = (t) => {
    t || (t = { x: e.positionX || "center", y: e.positionY || "auto" });
    const { left: n, top: o } = M({ inputRef: w, dropDownRef: L, positionX: t.x, positionY: t.y });
    D(n), z(o);
  };
  l(() => {
    const t = () => {
  ...
  const X = () => {
    ...
    var t, n;
    return n = E(), c(n, () => e.content), n;
  };
  return s = x(), i = s.firstChild, s.$$keyup = (t) => {
    t.key === "Escape" && (e.isShown || r()) && y();
  }, i.$$click = X, I(R, i), c(i, () => e.children), c(s, N(B, { get setIsShown() {
    ...
    var n = { ...e.width && { width: e.width || "100%" } }, o = g(e.className);
