...
export const Logo = () => {
  return (
    <div>
        ...
        class="e-9800-logo e-9800-baseline fill-primary " aria-label="Spotify" aria-hidden="false" height="32" data-encore-id="logoSpotify" style="--encore-logo-fill-color: var(--decorative-base);"><title>Spotify</title>
...
export const Home = () => {
  return (
    <div>
      <svg data-encore-id="icon" role="img" aria-hidden="true" class="e-9800-icon e-9800-baseline dark:invert " height="24" viewBox="0 0 24 24">
...
export const Menu = () => {
  return (
    <div>
      <svg data-encore-id="icon" role="img" aria-hidden="true" class="e-9800-icon e-9800-baseline e-9800-icon--auto-mirror dark:invert " height="16" viewBox="0 0 16 16" style="--encore-icon-height: var(--encore-graphic-size-decorative-smaller); --encore-icon-width: var(--encore-graphic-size-decorative-smaller);">
...
export const Replay = () => {
  return (
    <div>
      <svg data-encore-id="icon" role="img" aria-hidden="true" class="e-9800-icon e-9800-baseline e-9800-icon--auto-mirror " fill="currentColor" height="16" viewBox="0 0 16 16" style="--encore-icon-height: var(--encore-graphic-size-decorative-smaller); --encore-icon-width: var(--encore-graphic-size-decorative-smaller);">
