...
export default function Playbar() {
  ...
  return (
    <div class=" h-[72px] sticky bottom-0 left-0 right-0 bg-base-300 text-base-content px-4 py-1 z-2 grid grid-cols-10">
      {/* Left: Song Info */}
          ...
          <div class="flex flex-col items-center ">
            <button
              ...
              className={`btn bg-transparent p-0 size-fit border-none transition-all duration-100 hover:scale-103 ${
                shuffleState.active() ? "text-primary" : "hover:text-white"
              }`}
            >
              <Shuffle size={20} />
            </button>
            <div
              className={`size-1 transition-all duration-100  mt-1 bg-primary rounded-full ${
                shuffleState.active() ? "opacity-100" : "opacity-0"
              }`}
            ></div>
          </div>
          ...
          <div class="flex flex-col items-center justify-center">
            <button
              ...
              class={`btn bg-transparent p-0 size-fit border-none transition-all duration-100 hover:scale-103 ${
                replayMode() === 0 ? "hover:text-white" : "text-primary"
              }`}
            >
      ...
      <div class="flex items-center gap-3 col-span-3 justify-end">
        <div class="flex flex-col items-center ">
          <button
            onClick={() =>
              setActiveControl(activeControl() === "playing" ? null : "playing")
            }
            className={`btn bg-transparent p-0 size-fit border-none transition-all duration-100 hover:scale-103 ${
          ...
          <div
            className={`size-1 transition-all duration-100  mt-1 bg-primary rounded-full ${
              activeControl() === "playing" ? "opacity-100" : "opacity-0"
            }`}
          ></div>
        </div>
        <div class="flex flex-col items-center ">
          <button
            ...
            className={`btn bg-transparent p-0 size-fit border-none transition-all duration-100 hover:scale-103 ${
              micState.active() ? "text-primary" : "hover:text-white"
            }`}
          >
            <Mic />
          </button>
        ...
        <div class="flex flex-col items-center ">
          <button
            onClick={() =>
              setActiveControl(activeControl() === "align" ? null : "align")
            }
            className={`btn bg-transparent p-0 size-fit border-none transition-all duration-100 hover:scale-103 ${
              activeControl() === "align" ? "text-primary" : "hover:text-white"
            }`}
          >
          ...
          <div
            className={`size-1 transition-all duration-100  mt-1 bg-primary rounded-full ${
              activeControl() === "align" ? "opacity-100" : "opacity-0"
            }`}
          ></div>
        </div>
        <div class="flex flex-col items-center ">
          <button
            onClick={() =>
              setActiveControl(activeControl() === "device" ? null : "device")
            }
            className={`btn bg-transparent p-0 size-fit border-none transition-all duration-100 hover:scale-103 ${
              activeControl() === "device" ? "text-primary" : "hover:text-white"
            }`}
          >
            <Device />
          </button>
          <div
            className={`size-1 transition-all duration-100  mt-1 bg-primary rounded-full ${
              activeControl() === "device" ? "opacity-100" : "opacity-0"
            }`}
          ></div>
        </div>
        <div className="flex flex-col items-center ">
