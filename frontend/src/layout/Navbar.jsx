...
const Navbar = () => {
  ...
  <header className="antialiased sticky top-0 left-0 right-0 z-999  dark:bg-base-300 ">
    <nav className="bg-white border-gray-200 px-4 lg:px-6 py-2.5 dark:bg-base-300">
        <div className="flex flex-wrap justify-between items-center">
            ...
            <div className="flex items-center lg:order-2 lg:px-4">
                ...
                <button type="button" data-dropdown-toggle="notification-dropdown" className="btn btn-circle btn-ghost dark:hover:bg-base-100 mr-1 text-base-content hover:text-gray-900 hover:bg-gray-100 dark:text-base-content dark:hover:text-white">
                ...
                <button type="button" className="btn btn-circle overflow-hidden mx-3 hover:scale-105 hover:brightness-110 transition-all duration-200 md:mr-0" id="user-menu-button" aria-expanded="false" data-dropdown-toggle="dropdown">
                    <img className="size-full object-cover" src="IMG_7810.jpg" alt="user photo"/>
                </button>
                
                <div className="hidden z-50 my-4 w-56 text-base list-none bg-white rounded divide-y divide-gray-100 shadow dark:bg-base-200/95 dark:divide-gray-600" id="dropdown">
