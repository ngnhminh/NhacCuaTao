                    ...
                    <section class="flex items-center justify-center bg-[#1f1f1f]">
                        <div class="bg-[#1f1f1f] px-8 w-[324px] box-content">
                            <header className="mb-10 text-center">
                                <h1 class="text-[29px] font-bold text-balance text-white leading-[1.2]">
                            ...
                            <form onSubmit={handleSubmit} class="space-y-1.5">
                                ...
                                <button
                                    type="submit"
                                    class="w-full bg-[#1ed760] text-black py-2 px-8 mt-5 rounded-[9999px] cursor-pointer leading-[2] font-bold hover:bg-[#3be477] transition"
                                >
                                    Đăng nhập
                                </button>
                                <div className="mt-8 w-full relative flex justify-center border-b-2 border-[#292929]"></div>
                            </form>
