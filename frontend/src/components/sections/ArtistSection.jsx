                ...
                <div className="flex px-6 pb-6 items-center">
                    <button className="mr-4 cursor-pointer hover:scale-[1.02] transition">
                        <img
                            ...
                            src="https://i.scdn.co/image/ab67616100005174f8d2c15a9b3c1a049ec4286c"
                        />
                    </button>
                    ...
                    <For each={visibleSongs()}>
                        {(song) => (
                            <div className="h-14 pl-6 mb-4 hover:bg-[#ffffff1a] cursor-pointer rounded-sm group">
                                <div className="grid grid-cols-[minmax(200px,_1fr)_1fr_minmax(120px,_160px)] items-center h-14 gap-4">
                                    ...
                                    <div className="text-white text-sm text-center">
                                        {Number(song.listens).toLocaleString(
                                            'vi-VN'
                                        )}
                                    </div>
                            ...
                            <div className="max-w-[672px] p-10 text-left">
                                <div className="w-[204px] h-[204px] mb-6">
                                    <img
                                        ...
                                        src="https://i.scdn.co/image/ab6761610000939bf8d2c15a9b3c1a049ec4286c"
                                    />
                                </div>
                                ...
                                <div className="mt-2 text-[1rem] line-clamp-3">
                                    ...
                                    trào ca nhạc sinh viên từ Trường ĐH Xây dựng
                                    với các thành viên sáng lập Trần Lập - Trần
                                    Tuấn Hùng - Nguyễn Hoàng (trong đó Tuấn Hùng
                                    và Nguyễn Hoàng là sinh viên Đại học Xây
                                    dựng, Trần Lập học tại cao đẳng VH Nghệ
                                    thuật Hà nội). - 25 năm hoạt động, Bức Tường
                                    đã viết nên một câu chuyện kỳ diệu, bắt đầu
                                    từ những sinh viên Đại học với ước mơ nhỏ
                                    nhoi là mong có được những cây đàn của riêng
                                    mình, để rồi trở thành những nghệ sĩ hàng
                                    đầu trong nền âm nhạc Việt Nam. Đại diện cho
                                    VN tham dự các hoạt động văn hoá quốc tế, là
                                    một trong những người tiên phong và đem nhạc
                                    Rock tới với nhiều thế hệ khán giả trên cả
                                    nước. - Vượt qua khỏi những tác phẩm âm
                                    nhạc, Bức Tường trở thành biểu tượng của
                                    những giá trị tốt đẹp, là hình ảnh mẫu mực
                                    của một thế hệ thanh niên VN văn minh, dám
                                    mơ ước và thực hiện. - Bức Tường cũng là một
                                    trong số ít những Ban nhạc Rock của Việt Nam
                                    đã giành được 2 đề cử và 1 giải Cống hiến. -
                                    Trưởng nhóm của ban nhạc, ca sĩ Trần Lập, đã
                                    qua đời vào ngày 17/3/2016 do bệnh Ung thư
                                    trực tràng. - 3/2019, ra mắt Single Những
                                    ngày tháng tuyệt vời, một sáng tác của
                                    Guitarist Trần Tuấn Hùng. - 3/2020, phát
                                    hành tác phẩm XXV nhân kỷ niệm 25 năm thành
                                    lập. - 11/2020, phát hành album Vol.6 "Con
                                    Đường Không Tên"
                                </div>
                            </div>
                        </button>
