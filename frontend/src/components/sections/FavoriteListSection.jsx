...
export default function MainSection() {
    ...
    const getData = async () => {
            setLoading(true);
            try{
                const result = await getFavListInformService();
                setFavlistDetail(result.favoriteListInform)
                // console.log(result)
            }catch(err){
                console.error(err);
                    ...
                    <div className="flex px-4 pb-4">
                        <button className="mr-4 cursor-pointer hover:scale-[1.02] transition">
                            <img
                                ...
                                src={`${backendUrl}/media/playlistsImg/liked-songs-300.jpg`}
                            />
                        </button>
                            ...
                            <div className="flex flex-wrap items-center mt-2 text-[#ffffffb3]">
                                ...
                                <div className="flex whitespace-nowrap items-center">
                                    <span className="text-[#ffbdb9] text-sm font-normal whitespace-nowrap">
                                        {favlistDetail()?.song_number} bài hát
                                    </span>
                                    <span className="text-[#ffbdb9] text-sm font-normal whitespace-pre">
                                        ,{' '}
                                    </span>
                                    <span className="text-[#ffbdb9] text-sm font-normal whitespace-nowrap">
                                        {convert_seconds_to_time(favlistDetail()?.songs_duration)}
                                    </span>
                                </div>
                            </div>
                        </div>
                                ...
                                <div className="grid grid-cols-[16px_minmax(120px,_var(--col1,_4fr))_minmax(120px,_var(--col2,_1fr))] gap-4 h-14">
                                    ...
                                    <div className="flex items-center justify-end">
                                        <FavouriteButton
                                                            ...
                                                            songId={song.song_id} favoriteSongIds={favoriteSongIds()} 
