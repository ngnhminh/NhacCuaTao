...
const FollowArtistsCard = ({ type, name, id, img}) => {
    const navigate = useNavigate();
    return (
        <div 
            className="p-3 cursor-pointer hover:bg-[#1f1f1f] rounded-[6px] group"
        ...
        >
            ...
            <div className="text-sm text-[#b3b3b3]">{type}</div>
        </div>
    );
};

export default FollowArtistsCard;
