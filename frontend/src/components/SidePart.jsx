...
const SidePart = () => {
  let sidebarRef;
  const [sidebarWidth, setSidebarWidth] = createSignal("350px");
  ...
  return (
    <>
      <aside
        ...
        class={`flex-none relative overflow-hidden transition-all duration-300 ease-in rounded-md`}
        aria-label="Sidenav"
      >
        <SidebarResizer
        ...
        <div className={`flex flex-col items-stretch space-y-3 relative py-4  ${ isMinimalView() ? "px-1" : "px-4" } h-full  dark:bg-base-200 `}>
          ...
          {isMinimalView() ? (
            ...
            <div class="text-base-content whitespace-nowrap scrollbar pt-8 overflow-auto
            ...
            <>
              ...
              >
                ...
                >
                  ...
                  <button className="btn btn-ghost hover:bg-transparent border-none hover:scale-108 transition-all duration-100">
                    Gần đây
                    <Menu />
                  </button>
                </div>
              ...
              {!isNarrow() && (
                <div className="grid grid-cols-3 font-semibold text-xs whitespace-nowrap border-b border-base-100 pb-2 mb-2 text-base-content">
                  <div>Tiêu đề</div>
                  <div className="flex justify-center">Đã thêm Ngày</div>
                  <div className="flex flex-row-reverse">Đã phát</div>
                </div>
              )}
